            ...
            <div wire:loading.remove wire:target="selectHotspot">
                @if($selectedHotspot)
                    ...
                    <div class="mb-6 bg-white border border-gray-200 shadow-sm rounded-3xl p-5 flex items-stretch gap-6">
                        ...
                        <div class="relative w-20 h-40 border-l-2 border-b-2 border-gray-200 flex-shrink-0 flex justify-center items-end bg-gray-50/50 rounded-br-lg">

                            <div class="absolute left-0 bottom-[100%] w-2 border-b-2 border-gray-300"></div>
                            <span class="absolute -left-6 bottom-[95%] text-[8px] font-bold text-gray-400">170cm</span>

                            <div class="absolute left-0 bottom-[75%] w-2 border-b-2 border-gray-300"></div>
                            <div class="absolute left-0 bottom-[50%] w-2 border-b-2 border-gray-300"></div>
                            <div class="absolute left-0 bottom-[25%] w-2 border-b-2 border-gray-300"></div>

                            <svg class="absolute bottom-0 w-12 h-full text-gray-300 z-10" viewBox="0 0 24 24" fill="currentColor" preserveAspectRatio="xMidYMax meet">
                                <path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm3 15h-1.5v5H10.5v-5H9v-5c0-1.1.9-2 2-2h2c1.1 0 2 .9 2 2v5z"/>
                            </svg>

                            @php
                                $fillPercentage = min(100, ($selectedHotspot->water_level_cm / 170) * 100);
                            @endphp
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-600 to-blue-400/80 transition-all duration-1000 ease-in-out border-t-2 border-blue-300 shadow-[0_-5px_15px_rgba(59,130,246,0.3)] z-20"
